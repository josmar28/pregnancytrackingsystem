      ...
      <b-card class="mb-1">
        ...
        <b-row>
          <b-col cols="4" v-for="(item, index) in permissions" :key="index">
            <b-card border-variant="secondary" class="business-card">
...
} from "@core/comp-functions/roles";
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [
      ...
      {
        text: this.id
          ? this.$t("modules.roles.edit")
          : this.$t("modules.roles.create"),
        active: true,
      },
    ]);
  },
